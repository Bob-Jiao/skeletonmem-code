...
SAVE_ROOT="${RESULT_DIR}/a4_medium_train_${RUN_ID}"
TRAIN_LOG="${LOG_DIR}/gate_a4_medium_train_${RUN_ID}.log"
GPU_LOG="${LOG_DIR}/gate_a4_medium_gpu_${RUN_ID}.csv"
...
export LINGBOT_VA_TRAIN_STEPS="${LINGBOT_VA_TRAIN_STEPS:-50}"
export LINGBOT_VA_GRAD_ACCUM="${LINGBOT_VA_GRAD_ACCUM:-10}"
export LINGBOT_VA_SAVE_INTERVAL="${LINGBOT_VA_SAVE_INTERVAL:-50}"
