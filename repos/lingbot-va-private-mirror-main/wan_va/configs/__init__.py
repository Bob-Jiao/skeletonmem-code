...
from .va_libero_all_lora_train_cfg import va_libero_all_lora_train_cfg
from .va_ebench_cfg import va_ebench_cfg
from .va_ebench_train_cfg import va_ebench_train_cfg
...
VA_CONFIGS = {
    ...
    'libero_all_lora_train': va_libero_all_lora_train_cfg,
    'ebench': va_ebench_cfg,
    'ebench_train': va_ebench_train_cfg,
}
